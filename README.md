...
I'm also building open-source projects in the **Telegram bot** and **web application** space.
Still growing, but genuinely trying to give back to the community — one repo at a time. 🌱
...
| 📎 CV / Resume |
|:---:|
| _Link coming soon — feel free to reach out directly_ |
...
<sub>Alireza Pourgholam · علیرضا پورغلام · Frontend Developer · Telegram Bot Dev · Kish · Iran</sub>
</div>
